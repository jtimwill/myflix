  ...
  describe "POST create" do
    context "successful user sign up" do 
      ...
      it "sets the flash success message" do 
        expect(flash[:success]).to eq("Thank you for registering with MyFlix. Please sign in now.")
      end
    ...
    context "failed user sign up" do 
      let(:result) {double(:sign_up_result, successful?: false, error_message: "This is an error message")}
